...
(defun nano-theme--org ()
  ...
  (with-eval-after-load 'org
    ...
    (set-face 'org-level-1                            'nano-face-strong2)
    (set-face 'org-level-2                            'nano-face-strong3)
    (set-face 'org-level-3                            'nano-face-strong4)
    (set-face 'org-level-4                            'nano-face-strong5)
    (set-face 'org-level-5                            'nano-face-strong5)
    (set-face 'org-level-6                            'nano-face-strong5)
    (set-face 'org-level-7                            'nano-face-strong5)
    (set-face 'org-level-8                            'nano-face-strong5)
