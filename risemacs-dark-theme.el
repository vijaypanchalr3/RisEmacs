...
(defun dark-theme ()
  ...
  (setq nano-color-salient    "#B48EAD")
  (setq nano-color-strong     "#FFFFFF") ;; Snow Storm 3  / nord  6
  (setq nano-color-popout     "#D08770") ;; Aurora        / nord 12
  (setq nano-color-subtle     "#76A0BC") ;; Polar Night 2 / nord  2
  (setq nano-color-faded      "#677691") ;;
  )

(dark-theme)

(provide 'risemacs-dark-theme)
