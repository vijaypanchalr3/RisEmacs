...
(defun nano-theme-set-dark ()
  ...
  (setq nano-color-background "#000000")
  (setq nano-color-highlight  "#2d2d2d")
  (setq nano-color-critical   "#EBCB8B")
  (setq nano-color-salient    "#81A1C1")
  (setq nano-color-strong     "#bbfff4")
  (setq nano-color-strong2     "#bbfff4")
  (setq nano-color-strong3     "#2df8de")
  (setq nano-color-strong4     "#00cdb4")
  (setq nano-color-strong5     "#00bba6")
