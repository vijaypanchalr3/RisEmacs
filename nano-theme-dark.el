...
(defun nano-theme-set-dark ()
  ...
  (setq nano-color-strong     "#c7fef4") ;; Snow Storm 3  / nord  6
  (setq nano-color-strong2     "#c0f5eb") ;; Snow Storm 3  / nord  6
  (setq nano-color-strong3     "#b8ebe1") ;; Snow Storm 3  / nord  6
  (setq nano-color-strong4     "#b0e0d7") ;; Snow Storm 3  / nord  6
  (setq nano-color-strong5     "#b0e0d7") ;; Snow Storm 3  / nord  6
  (setq nano-color-popout     "#D08770") ;; Aurora        / nord 12
  (setq nano-color-subtle     "#434C5E") ;; Polar Night 2 / nord  2
  (setq nano-color-faded      "#00594b") ;;
  (setq nano-color-faded2      "#00594b") ;;
